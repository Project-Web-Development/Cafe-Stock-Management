...
export default function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <Link to="/Home" className="flex items-center text-[#ffffff]">
          Home
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link to="/Stock" className="flex items-center text-[#ffffff]">
          Stock
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link to="/Docs" className="flex items-center text-[#ffffff]">
          Profile
        </Link>
      </Typography>
    </ul>
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 bg-[#212121] border-0">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        <div className="flex items-center">
          <img src={logo} alt="Nama Gambar" className="h-8 w-8 mr-2" />
          <Typography
            as="a"
            href="#"
            className="mr-4 cursor-pointer py-1.5 font-medium text-[#ffffff]"
          >
            My Cafe Stock
          </Typography>
        </div>
        ...
        <div className="flex items-center gap-x-1">
          <Button
            variant="gradient"
            size="sm"
            className="hidden lg:inline-block text-[#ffffff]"
